    ...
    return(
        <>
            ...
            <NavBar title="Project Tracker" shadowOnScroll={true}>
                ...
                <NavBarLink to="/" exact={true} text="Accueil" icon={<i className="icons10-home"></i>}/>
                <NavBarLink to="/editor" exact={true} text="Editeur de texte"/>
                <NavBarLink to="/electron" text="Page 2" icon={<i className="icons10-grid-2"></i>}/>
                <NavBarLink to="/react-native" text="Page 3" icon={<i className="icons10-columns"></i>}/>
            </NavBar>
